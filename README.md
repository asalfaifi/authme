...
The AuthMe-native API is intentionally small and is not Keycloak Admin REST compatible. Authenticate every call with `Authorization: Bearer $AUTHME_ADMIN_TOKEN`.
